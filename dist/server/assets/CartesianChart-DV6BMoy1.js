import { W as requireReact, S as reactExports, w as getDefaultExportFromCjs, R as React } from "./server-Buj_o9pi.js";
import { f as clsx, r as reactDomExports } from "./router-C6fCM03v.js";
import { r as requireShim } from "./index-Dg6PRTG0.js";
...
var Surface = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("svg", _extends$9({}, svgPropertiesAndEvents(others), {
...
var Layer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("g", _extends$8({
    className: layerClass
...
var ResponsiveContainer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(SizeDetectorContainer, _extends$7({}, props, {
    width,
    height,
    ref
  }));
...
var getPath = (_ref2) => {
  ...
  if (Array.isArray(baseLine)) {
    var _lineFunction;
    var areaPoints = points.map((entry, index) => _objectSpread$g(_objectSpread$g({}, entry), {}, {
      base: baseLine[index]
    }));
    if (layout === "vertical") {
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$6({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
  ...
  return _objectSpread$c(_objectSpread$c({}, implicitAngleAxis), {}, {
    type: evaluatedType
  });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
  ...
  return _objectSpread$c(_objectSpread$c({}, implicitRadiusAxis), {}, {
    type: evaluatedType
  });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
  ...
  if (hasBeenActivePreviously(appropriateMouseInteraction)) {
    if (activeFromProps) {
      return _objectSpread$a(_objectSpread$a({}, appropriateMouseInteraction), {}, {
        active: true
      });
    }
  ...
  return _objectSpread$a(_objectSpread$a({}, noInteraction), {}, {
  ...
  return tooltipPayloadConfigurations.reduce((agg, _ref2) => {
    ...
    if (Array.isArray(tooltipPayload)) {
      tooltipPayload.forEach((item) => {
        ...
        var newSettings = _objectSpread$9(_objectSpread$9({}, settings), {}, {
          name: itemName,
    ...
    var listener2 = (incomingSyncId, action, emitter) => {
      ...
      if (syncMethod === "index") {
        ...
        if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
          ...
          var scaledCoordinate = _objectSpread$6(_objectSpread$6({}, otherCoordinateProps), {}, {
            x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
            y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
          });
          dispatch(_objectSpread$6(_objectSpread$6({}, action), {}, {
            payload: _objectSpread$6(_objectSpread$6({}, action.payload), {}, {
...
var currentConfig = _objectSpread$5({}, defaultConfig);
...
_defineProperty$5(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
function Label(outerProps) {
  ...
  var propsWithViewBox = _objectSpread$3(_objectSpread$3({}, props), {}, {
    viewBox
  });
  ...
  if (isPolar(viewBox)) {
    ...
    positionAttrs = _objectSpread$3(_objectSpread$3({
      x: cartesianResult.x,
      y: cartesianResult.y,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(label)) {
    if (label.type === Label) {
      return /* @__PURE__ */ reactExports.cloneElement(label, _objectSpread$3({
        key: "label-implicit"
      }, commonProps));
    }
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$4({
  ...
  reducers: {
    ...
    updateYAxisWidth(state, action) {
      ...
      if (axis) {
        ...
        state.yAxis[id] = _objectSpread$2(_objectSpread$2({}, axis), {}, {
          width,
...
export {
  getCateCoordinateOfBar as $,
  combineAppliedValues as A,
  combineAxisDomain as B,
  CartesianChart as C,
  DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME as D,
  combineAxisDomainWithNiceTicks as E,
  combineCheckedDomain as F,
  Global as G,
  combineDisplayedData as H,
  combineDomainOfAllAppliedNumericalValuesIncludingErrorValues as I,
  JavascriptAnimate as J,
  combineGraphicalItemsData as K,
  LabelListFromLabelProp as L,
  combineGraphicalItemsSettings as M,
  combineNiceTicks as N,
  combineNumericalDomain as O,
  PolarLabelListContextProvider as P,
  constant$1 as Q,
  RADIAN as R,
  SetCartesianGraphicalItem as S,
  Text as T,
  createSelector as U,
  findAllByType as V,
  get$1 as W,
  getAxisTypeBasedOnLayout as X,
  getBandSizeOfAxis as Y,
  ZIndexLayer as Z,
  getBaseValueOfBar as _,
  CartesianLabelContextProvider as a,
  selectCartesianAxisSize as a$,
  getCateCoordinateOfLine as a0,
  getCoordinatesOfGrid as a1,
  getMaxRadius as a2,
  getNormalizedStackId as a3,
  getPercentValue as a4,
  getStackSeriesIdentifier as a5,
  getStringSize as a6,
  getTicksOfAxis as a7,
  getTooltipNameProp as a8,
  getTransitionVal as a9,
  removeXAxis as aA,
  removeYAxis as aB,
  replaceXAxis as aC,
  replaceYAxis as aD,
  requireGet$1 as aE,
  requireIsArrayLike as aF,
  requireIsDeepKey as aG,
  requireIsEqualsSameValueZero as aH,
  requireIsIndex as aI,
  requireIsObject as aJ,
  requireToKey as aK,
  requireToPath as aL,
  resolveDefaultProps as aM,
  round$1 as aN,
  roundTemplateLiteral as aO,
  selectActiveCoordinate as aP,
  selectActiveLabel as aQ,
  selectActiveTooltipDataKey as aR,
  selectActiveTooltipGraphicalItemId as aS,
  selectActiveTooltipIndex as aT,
  selectAllErrorBarSettings as aU,
  selectAxisPropsNeededForCartesianGridTicksGenerator as aV,
  selectAxisViewBox as aW,
  selectAxisWithScale as aX,
  selectBarCategoryGap as aY,
  selectBarGap as aZ,
  selectBaseAxis as a_,
  getValueByDataKey as aa,
  implicitXAxis as ab,
  implicitYAxis as ac,
  ...
  isClipDot as ag,
  isLabelContentAFunction as ah,
  isNan as ai,
  isNullish as aj,
  isNumOrStr as ak,
  isNumber as al,
  isPolarCoordinate as am,
  isPositiveNumber as an,
  isStacked as ao,
  isValidTextAnchor as ap,
  isWellBehavedNumber as aq,
  itemAxisPredicate as ar,
  mathSign as as,
  mouseLeaveItem as at,
  noop$2 as au,
  pickAxisId as av,
  pickAxisType as aw,
  polarToCartesian as ax,
  propsAreEqual as ay,
  removeRenderedTicks as az,
  CartesianLabelFromLabelProp as b,
  usePrefersReducedMotion as b$,
  selectChartBaseValue as b0,
  selectChartDataAndAlwaysIgnoreIndexes as b1,
  selectChartDataSliceIgnoringIndexes as b2,
  selectChartDataWithIndexesIfNotInPanoramaPosition3 as b3,
  selectChartDataWithIndexesIfNotInPanoramaPosition4 as b4,
  selectChartLayout as b5,
  selectChartOffsetInternal as b6,
  selectDomainDefinition as b7,
  selectDomainFromUserPreference as b8,
  selectIsTooltipActive as b9,
  setRenderedTicks as bA,
  setTooltipSettingsState as bB,
  sortBy$1 as bC,
  svgPropertiesAndEvents as bD,
  svgPropertiesAndEventsFromUnknown as bE,
  svgPropertiesNoEvents as bF,
  svgPropertiesNoEventsFromUnknown as bG,
  truncateByDomain as bH,
  updatePolarOptions as bI,
  updateYAxisWidth as bJ,
  upperFirst as bK,
  useAccessibilityLayer as bL,
  useActiveTooltipDataPoints as bM,
  useAnimationId as bN,
  useAppDispatch as bO,
  useAppSelector as bP,
  useCartesianChartLayout as bQ,
  useChartHeight as bR,
  useChartLayout as bS,
  useChartName as bT,
  useChartWidth as bU,
  useIsPanorama as bV,
  useLegendPortal as bW,
  useMargin as bX,
  useNeedsClip as bY,
  useOffsetInternal as bZ,
  usePlotArea as b_,
  selectLegendPayload as ba,
  selectRealScaleType as bb,
  selectRenderableAxisSettings as bc,
  selectRootBarSize as bd,
  selectRootMaxBarSize as be,
  selectStackGroups as bf,
  selectStackOffsetType as bg,
  selectTicksOfAxis as bh,
  selectTicksOfGraphicalItem as bi,
  selectTooltipAxis as bj,
  selectTooltipAxisScale as bk,
  selectTooltipAxisTicks as bl,
  selectTooltipPayload as bm,
  selectUnfilteredCartesianItems as bn,
  selectXAxisIdFromGraphicalItemId as bo,
  selectXAxisPosition as bp,
  selectXAxisSettingsNoDefaults as bq,
  selectXAxisSize as br,
  selectYAxisIdFromGraphicalItemId as bs,
  selectYAxisPosition as bt,
  selectYAxisSettingsNoDefaults as bu,
  selectYAxisSize as bv,
  setActiveClickItemIndex as bw,
  setActiveMouseOverItemIndex as bx,
  setLegendSettings as by,
  setLegendSize as bz,
  CartesianLabelListContextProvider as c,
  useTooltipChartSynchronisation as c0,
  useTooltipEventType as c1,
  useTooltipPortal as c2,
  useViewBox as c3,
  warn as c4,
  withPath as c5,
  CategoricalChart as d,
  ChartDataContextProvider as e,
  Curve as f,
  DATA_ITEM_INDEX_ATTRIBUTE_NAME as g,
  DefaultZIndexes as h,
  GraphicalItemClipPath as i,
  Layer as j,
  RechartsStoreProvider as k,
  RegisterGraphicalItemId as l,
  ReportChartProps as m,
  ReportEventSettings as n,
  ReportMainChartProps as o,
  ResponsiveContainer as p,
  SetLegendPayload as q,
  SetPolarGraphicalItem as r,
  SetPolarLegendPayload as s,
  SetTooltipEntrySettings as t,
  Surface as u,
  adaptEventHandlers as v,
  adaptEventsOfChild as w,
  addXAxis as x,
  addYAxis as y,
  arrayTooltipSearcher as z
};
