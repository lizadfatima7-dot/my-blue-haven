...
import { C as useTheme, y as useI18n, p as languages, L as Link, a as Button, E as Earth } from "./router-CjVt23mV.js";
import { u as useRouterState, D as DropdownMenu, e as DropdownMenuTrigger, a as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, b as DropdownMenuItem, S as Sun, M as Moon } from "./dropdown-menu-DpuOH9sD.js";
import { Z as Zap } from "./zap-CxVCsrS_.js";
import { C as ChevronDown } from "./chevron-down-BWTbW6T6.js";
import { C as Check } from "./index-Bq5GC4r3.js";
function MarketingNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-3 flex max-w-6xl items-center justify-between rounded-2xl glass px-4 py-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold tracking-tight", children: "Voltly" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-8 px-6 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Voltly" })
        ] }),
