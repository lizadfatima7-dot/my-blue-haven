import { S as reactExports, J as jsxRuntimeExports, O as Outlet } from "./server-Buj_o9pi.js";
import { l as createLucideIcon, m as createSlot, g as cn, X, n as cva, w as useComposedRefs, b as Primitive$1, h as composeEventHandlers, k as createContextScope, P as Presence, S as Slot, a as Button, I as Input, u as useAuth, A as useNavigate, L as Link, C as useTheme, s as supabase, U as User } from "./router-C6fCM03v.js";
import { R as Root$1, P as Portal$1, a as Content, C as Close, T as Title, D as Description, O as Overlay, c as Root$2, b as Cpu } from "./index-CJRCMQdq.js";
import { b as Root2, A as Anchor, c as createPopperScope, P as Portal$2, D as DismissableLayer, C as Content$1, a as Arrow } from "./Combination-D9enl8gd.js";
import { u as useId } from "./index-L34_ugnB.js";
import { u as useControllableState } from "./index-DD10tKAZ.js";
import { u as useRouterState, S as Sun, M as Moon, D as DropdownMenu, e as DropdownMenuTrigger, a as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, b as DropdownMenuItem } from "./dropdown-menu-CT0bDAum.js";
import { Z as Zap } from "./zap-BeezbeaP.js";
import { C as ChartColumn } from "./chart-column-BqzXMNhV.js";
import { F as FileText } from "./file-text-C2g5AWKd.js";
import { M as Mail } from "./mail-BLMKYSNg.js";
import { A as Avatar, a as AvatarFallback } from "./avatar-CLhlYXLE.js";
import { h as monthlyCost } from "./energy-DCMlEQOJ.js";
import { g as getSpendingLimit } from "./spending-limit-DdEaaNKD.js";
...
const main = [
  ...
  { title: "Analitika", url: "/analytics", icon: ChartColumn },
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", className: "flex items-center gap-2 px-2 py-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { children: "İş sahəsi" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: main.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: path === item.url, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.title })
        ] }) }) }, item.url)) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { children: "Əlavə" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: more.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: path === item.url, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.title })
        ] }) }) }, item.url)) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 p-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate px-2 text-xs text-muted-foreground", children: user?.email }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", onClick: handleSignOut, className: "justify-start gap-2", children: [
...
function AppNavbar() {
  ...
  const [spendingLimit, setSpendingLimitState] = reactExports.useState(50);
  ...
  const notifications = reactExports.useMemo(() => [
    ...hasLimitWarning ? [{ title: `Xəbərdarlıq: aylıq xərc ${currentCost.toFixed(2)} AZN oldu və ${spendingLimit} AZN limitini keçdi`, time: "indi" }] : [],
    ...NOTIFS
  ], [currentCost, hasLimitWarning, spendingLimit]);
  reactExports.useEffect(() => {
    if (!user) return;
    setSpendingLimitState(getSpendingLimit(user.id));
    supabase.from("devices").select("*").eq("user_id", user.id).then(({ data }) => setDevices(data ?? []));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex h-14 items-center gap-3 border-b glass px-3 md:px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: toggle, "aria-label": "Mövzunu dəyiş", children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { open: notifOpen, onOpenChange: setNotifOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "icon", className: "relative", "aria-label": "Bildirişlər", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute right-1.5 top-1.5 h-2 w-2 rounded-full ${hasLimitWarning ? "bg-destructive" : "bg-accent"}` })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-72", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { children: "Bildirişlər" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
          notifications.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { className: "flex flex-col items-start gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: n.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: n.time })
          ] }, n.title))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded-full focus:outline-none focus:ring-2 focus:ring-ring", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { style: { background: "var(--gradient-blue)", color: "white" }, children: initial }) }) }) }),
...
function AppLayout() {
  ...
  if (loading || !session) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", style: {
