...
const translations: Record<Language, TranslationTree> = {
  az: {
    ...
    heroDescription: "Elektrik istifadənizi ağıllı şəkildə izləyin və enerji israfını azaldın. Voltly xam məlumatları aydın, icra edilə bilən tövsiyələrə çevirir.",
    liveDemo: "Canlı demo",
    ...
    features: [
      ...
      "AI tövsiyələri|İstifadə vərdişlərinizdən öyrənən fərdiləşdirilmiş məsləhətlər.",
    ...
    aboutDescription: "Voltly-nin missiyası sadədir: hər bir ev təsərrüfatına xoş və ağıllı alətlərlə elektrik istehlakını anlamağa və azaltmağa kömək etmək.",
    ourTeam: "Komandamız",
    ...
    faqs: [
      "Enerji istifadəm necə hesablanır?|Voltly cihaz gücü, gündəlik işləmə saatı və canlı monitorinq məlumatlarını birləşdirərək kWh istifadəsini hesablayır.",
      "Cihaz monitorinqi nə göstərir?|Hər cihazın aktiv statusu, gücü, gündəlik işləmə müddəti və aylıq enerji payı göstərilir.",
      "Hesabatları necə yükləyə bilərəm?|Reports bölməsində PDF və Excel düymələrindən istifadə edərək peşəkar hesabatları yükləyə bilərsiniz.",
      "CO₂ azalması necə hesablanır?|Sistem qənaət edilən kWh dəyərini karbon emissiya əmsalı ilə müqayisə edir.",
      "Hesab ayarlarını haradan dəyişə bilərəm?|Settings və Profile bölmələrində şəxsi məlumatlarınızı və tətbiq seçimlərinizi idarə edə bilərsiniz.",
    ],
...
function getInitialLanguage(): Language {
  ...
  const stored = window.localStorage.getItem("voltly-language");
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem("voltly-language", language);
  }, [language]);
