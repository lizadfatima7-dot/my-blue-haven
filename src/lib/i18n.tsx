...
const translations: Record<Language, TranslationTree> = {
  az: {
    ...
    heroDescription: "Elektrik istifadənizi ağıllı şəkildə izləyin və enerji israfını azaldın. Voltix xam məlumatları aydın, icra edilə bilən tövsiyələrə çevirir.",
    liveDemo: "Canlı demo",
    ...
    aboutDescription: "Voltix-nin missiyası sadədir: hər bir ev təsərrüfatına xoş və ağıllı alətlərlə elektrik istehlakını anlamağa və azaltmağa kömək etmək.",
    ourTeam: "Komandamız",
    ...
    faqs: [
      "Enerji istifadəm necə hesablanır?|Voltix cihaz gücü, gündəlik işləmə saatı və canlı monitorinq məlumatlarını birləşdirərək kWh istifadəsini hesablayır.",
...
function getInitialLanguage(): Language {
  ...
  const stored = window.localStorage.getItem("voltix-language");
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem("voltix-language", language);
  }, [language]);
